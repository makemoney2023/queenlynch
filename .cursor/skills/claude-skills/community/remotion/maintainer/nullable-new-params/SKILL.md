...
```sh
bun .cursor/skills/nullable-new-params/scripts/find-new-optional-params.ts
```

Useful variants:

```sh
bun .cursor/skills/nullable-new-params/scripts/find-new-optional-params.ts origin/main...HEAD
bun .cursor/skills/nullable-new-params/scripts/find-new-optional-params.ts --cached
```
