...
export function MacosGlassMockup({
  children,
  config,
  className = "",
  shadows = 20,
    ...
    <div className={`relative w-full h-full flex flex-col ${className}`}>
      ...
      <div
        ...
        style={{
          ...
          borderRadius: `${Math.max(0, cornerRadius + 4)}px`,
      ...
      >
        <div
          className="glass-border w-full h-full flex flex-col overflow-hidden relative z-10"
          style={{
            borderRadius: `${cornerRadius}px`,
        ...
        >
          <div
            ...
            style={{
              ...
              borderTopLeftRadius: `${Math.max(0, cornerRadius - 4)}px`,
              borderTopRightRadius: `${Math.max(0, cornerRadius - 4)}px`,
            }}
          >
          ...
          <div
            ...
            style={{
              ...
              borderBottomLeftRadius: `${Math.max(0, cornerRadius - 4)}px`,
              borderBottomRightRadius: `${Math.max(0, cornerRadius - 4)}px`,
            }}
          >
            {children}
          </div>
