...
# Install each of the four skills into your project's .cursor/skills/
cd /path/to/your/project
mkdir -p .cursor/skills
ln -s ~/academic-research-skills/deep-research .cursor/skills/deep-research
ln -s ~/academic-research-skills/academic-paper .cursor/skills/academic-paper
ln -s ~/academic-research-skills/academic-paper-reviewer .cursor/skills/academic-paper-reviewer
ln -s ~/academic-research-skills/academic-pipeline .cursor/skills/academic-pipeline
```

Each skill must sit at `.cursor/skills/<skill-name>/SKILL.md` for Claude Code to discover it. See [docs/SETUP.md](docs/SETUP.md) for the copy-based alternative, global `~/.cursor/skills/` install, and the other installation methods (Claude Code plugin, Cowork via zip upload, claude.ai). Note that Cowork and claude.ai do not read `~/.cursor/skills/` — they install skills through their own settings upload, not this path.
